...
\section{Light-sheet microscopy}
  ...
  \subsection{Static light-sheet illumination}
    ...
    The shape of the illumination light determines the optical sectioning capability and the filed of view of the microscope, so it is important to be able to quantify these measures. To this end, let's a laser beams properties described by Gaussian beam optics.
