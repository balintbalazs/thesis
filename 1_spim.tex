...
\section{Light-sheet microscopy}
  ...
  and light-sheet
  these techniques were all combined in the 2004 Science paper from Huisken \textit{et al.} that marks a landmark in light-sheet microscopy, and since then a widespread adoption started  in biological research, with multiple groups implementing their own setups.
  ...
  \subsection{Static light-sheet illumination}
    ...
    For paraxial waves, i.e. waves with nearly parallel wave front normals, a general wave equation can be approximated with the paraxial Helmholtz equation \cite{krzic_multiple-view_2009, saleh_fundamentals_2007}
    \begin{equation}
...
\section{Further applications of light-sheet microscopy}
  \label{sec:multiview}
  \begin{figure}
    \centering
  ...
  "Multiple imaging axis microscopy (MIAM) \cite{swoger_multiple_2003}to image specimens from 4 directions in a tetrahedral objective configuration,could reach a 5.8 fold increase in axial resolution by combining the four views as a weighted average."
