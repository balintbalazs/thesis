...
Discovery and purification of green fluorescent protein from \textit{Aequorea victoria} \cite{shimomura_extraction_1962}
cloning of GFP  cDNA \cite{prasher_primary_1992}
first GFP applications as in vivo cell markers: nematodes \cite{chalfie_green_1994}, zebrafish \cite{amsterdam_aequorea_1995}, mouse \cite{okabe_green_1997}
...
\begin{figure}[htbp]
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[page=4,width=0.8\textwidth]{spim_cyl}
        \caption{\textbf{Optical layout}}
        \label{fig:wide-field}
    \end{subfigure}
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[page=6,width=\textwidth]{spim_cyl}
        \caption{\textbf{Light collection of a wide-field miroscope.}}
        \label{fig:alpha}
    \end{subfigure}
    \caption{\textbf{Wide-field fluorescence microscope.} (a) The light source is focused on the back focal plane of the objective to provide an even illumination to the sample. Emitted photons are collected by the objective, and are separated from the illumination light by a dichroic mirror. (b) , $\alpha$}
\end{figure}

Apart from magnification, the most important property of the objective is the half-angle of the light acceptance cone
...
\begin{equation}
    NA \approx n \frac{d}{f},\quad \text{when }\alpha \ll 1
\end{equation}
...
scalar theory of diffraction (no polarization), intensity of PSF Fraunhofer diffraction \cite{born_principles_2013}

\begin{equation}
    H(u,v) = C_0 \left| \int_0^1 J_0 (vr)e^{i\cdot ur^2} rdr \right|^2
    \label{eq:psf}
\end{equation}
