...
base = '/home/balazs/mnt/hufnagel-data/balazs/GPU_fusion_test/2017-01-18_newOctagon_33.3x/2017-01-18_17.37.51_forConfig_area'
...
config['beads_LC'].append(base+beadsFolder+'/Stack_0_Channel_0/Cam_Right_%(t)05d.h5')
#config['beads_LC'].append(base+beadsFolder+'/Stack_1_Channel_0/Cam_Left_%(t)05d.h5')
config['beads_RC'].append(base+beadsFolder+'/Stack_0_Channel_0/Cam_Left_%(t)05d.h5')
#config['beads_RC'].append(base+beadsFolder+'/Stack_1_Channel_0/Cam_Right_%(t)05d.h5')

# timepoints
config['data_LC'],config['data_RC'] = [],[]
config['data_LC'].append(base+dataFolder+'/Stack_0_Channel_0/Cam_Right_%(t)05d.h5')
#config['data_LC'].append(base+dataFolder+'/Stack_1_Channel_0/Cam_Left_%(t)05d.h5')
config['data_RC'].append(base+dataFolder+'/Stack_0_Channel_0/Cam_Left_%(t)05d.h5')
#config['data_RC'].append(base+dataFolder+'/Stack_1_Channel_0/Cam_Right_%(t)05d.h5')
...
config['addData_LC'].append(base+dataFolder+'/Stack_0_Channel_1/Cam_Left_%(t)05d.h5')
config['addData_LC'].append(base+dataFolder+'/Stack_1_Channel_1/Cam_Left_%(t)05d.h5')
config['addData_RC'].append(base+dataFolder+'/Stack_0_Channel_1/Cam_Right_%(t)05d.h5')
config['addData_RC'].append(base+dataFolder+'/Stack_1_Channel_1/Cam_Right_%(t)05d.h5')
...
config['outDir'] = os.path.join(base,'Fused') # enough to set this variable to an empty folder
...
config['keepTemporaryImageFiles']       = False   # referring to: opposing stacks (unaligned and aligned), elastix masks
...
config['useSigmoidalsBetweenCameras']   = False   # fusion between opposing camera views: if True, sigmoids are used for only taking into account the optimal views,
                                                 # otherwise a simple sum of the views is performed
