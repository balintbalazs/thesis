...
\section{Results}
  ...
  \subsection{Characterizing illumination profile}
    ...
    To visualize the beam, the chamber was filled with a fluorescent solution (methylene blue solution in distilled water). In order to increase the signal to noise ratio of these images, a long exposure time of \SI200}{ms} were used, and 500 images of each beam was averaged (Fig. \ref{fig:beamProfiles}).

    \begin{figure}[htb]
      \centering
      \includegraphics[width=\textwidth]{beamProfiles3}
