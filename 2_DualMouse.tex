...
\section{Results}
  ...
  \subsection{Characterizing illumination profile}
    ...
    \begin{figure}[htb]
      ...
      \bcaption[Illumination beam profile]{Average of 50 stationary beam images for both left (top left) and right objectives (bottom left). Beam intensity profile along the waist of each beam is plotted in the center column. The right column shows the beam width profile of each beam ($1/e^2$).}
