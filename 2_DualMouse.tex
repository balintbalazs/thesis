...
\section{Optical layout}
  ...
  \label{sec:core}
    \begin{figure}
      ...
      \bcaption[The Core]{The two objectives (O and O') are mounted on a solid \SI{15}{mm} thick aluminium plate. The objectives are held at the front by the chamber (Ch), and at the back by a mirror block (M and M'). Excitation (Ex.) and emission (Em.) light paths are indicated by the dash-dot line. Due to the symmetric arrangement, the excitation and illumination paths can be switched around.}
      \label{fig:Core}
    \end{figure}

    As the most important part of the microscope is actually the sample, the design is based around a core consisting of the imaging chamber and the objectives (\autoref{fig:Core}). 
