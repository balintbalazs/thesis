...
\label{sec:120concept}
  ...
  \subsection{Light-sheet design}
    ...
    The height of the light-sheet can be adjusted by changing the beam scanning amplitude with the galvo mirror. To scan the entire field of view of $h_{\mathrm{FOV}} = \SI{270}{\micro m}$, the scanning angle range at the back focal plane of the objective will need to be $ \theta = \tan^{-1}(h_{\mathrm{FOV}}/2/f_o) = \pm \SI{0.967}{\degree}$.
