...
\subsection{Results}
  ...
  \[
  \begin{pmatrix}
    1.013 & 2.497\times 10^{-3} & 7.110\times 10^{-3} & -21.71 \\
    -1.701\times 10^{-3} & 1.014 & -1.980\times 10^{-3} & -4.085 \\
    2.667\times 10^{-6} & -6.816\times 10^{-5} & 1.003 & -0.566 \\
    0 & 0 & 0 & 1
  \end{pmatrix}
  \]

  \begin{align*}    
    \max |cz| =& \SI{0.0693}{\micro m}  \\
    \max |gz| =& \SI{0.019}{\micro m}  \\
    \max | i x + j y + (k-1)  z + l | =& \SI{0.8384}{\micro m}
  \end{align*}
