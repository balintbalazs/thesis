...
\chapter{Symmetric Mouse SPIM}

\section{Motivation}

\section{Light-sheet microscopy}
	\subsection{Fluorescence}
	\subsection{Wide-field microscopy}
	\subsection{Confocal laser scanning microscopy}
	\subsection{Light-sheet microscopy}
		\cite{huisken_optical_2004}
	\subsection{MuVi-SPIM}
		\cite{krzic_multiview_2012}
	\subsection{Mouse-SPIM}
		\cite{strnad_inverted_2016}
...
Fluorescent microscopy is especially suitable to image live specimens, since a lot of organisms have naturally fluorescent structures. This phenomenon is called autofluorescence.
...
One of the simplest fluorescent microscopes is a wide-field fluorescent microscope (Figure \ref{fig:wide-field}). The main difference to a regular microscope, is the introduction of a filter cube. This cube contains an
excitation filter, emission filter and a dichroic mirror. The dichroic mirror is used to couple the illumination and detection light paths, and the filters are used to separate the fluorescent light from the excitation light. The image of the sample is focused on the detector of a digital camera.

\begin{figure}[htbp]
	\centering
	\includegraphics[page=4,scale=0.8]{figures/2_spim/intro/spim_cyl}
...
\begin{subfigure}[t]{0.49\textwidth}
	\centering
	\includegraphics[page=3,width=\textwidth]{figures/2_spim/intro/spim_cyl}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[page=1,width=0.8\textwidth]{figures/2_spim/intro/spim_cyl}
...
\begin{figure}[hbt]
	\centering
	\includegraphics[page=2,width=0.8\textwidth]{figures/2_spim/intro/spim_cyl}
...
\section{Dual Mouse-SPIM}
	\subsection{Previous Mouse-SPIM}
	\subsection{3D figure test}
...
]{\includegraphics{figures/2_spim/DualMouse/Splitter.png}}{figures/2_spim/DualMouse/Splitter.prc}
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum sodales dignissim eros in accumsan. Donec sapien augue, suscipit ac imperdiet sed, malesuada id orci. Interdum et malesuada fames ac ante ipsum primis in faucibus. Donec pharetra sem non nibh accumsan, sed faucibus mauris placerat. Sed et augue et erat bibendum vestibulum. Nunc porttitor eros sed tincidunt varius. Aenean eget orci a libero molestie consectetur. Proin rutrum magna eu est eleifend tincidunt. Vivamus semper orci ut arcu rutrum, ac pellentesque nisl posuere. Nulla ac convallis neque.

Etiam quis erat pulvinar, dictum leo sollicitudin, viverra ante. Morbi non risus venenatis purus eleifend convallis. Sed scelerisque tellus et ipsum maximus, ut finibus ligula varius. Etiam pulvinar nisl quis turpis venenatis pulvinar. Aliquam erat volutpat. Vestibulum sit amet purus non elit egestas elementum ut non turpis. Etiam ac blandit est.

Nam scelerisque placerat viverra. Vestibulum facilisis viverra tincidunt. Nunc eleifend lacus vel mi imperdiet elementum. Nulla id augue lacus. Donec eget congue risus. Nam consequat faucibus lacus quis aliquam. Maecenas nec turpis eu nibh tempus commodo ut in augue. Aenean euismod sapien eleifend mauris gravida ultricies vel sed felis. Curabitur faucibus dui orci, eget convallis sem gravida eget. Mauris ac dui sed ligula dictum sodales ut non ligula.

Vivamus iaculis molestie rutrum. Aenean sit amet eros ex. Aliquam erat volutpat. Proin neque lacus, placerat at sapien eu, consectetur viverra massa. Nullam venenatis fermentum vulputate. Mauris semper tellus pellentesque, blandit tellus maximus, porttitor libero. Duis vulputate purus ac facilisis ultrices. Fusce vel ante mauris. Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque fringilla euismod ipsum eu consequat. Sed sed neque sit amet elit viverra vehicula et nec nisi. Suspendisse potenti.

Mauris ipsum sapien, gravida ac diam at, accumsan dictum nibh. Etiam mi odio, dictum sit amet augue et, egestas iaculis diam. Sed suscipit augue eros, nec fringilla odio hendrerit vel. Sed volutpat dui magna. Aliquam justo ligula, ultrices a blandit eu, posuere in justo. In hac habitasse platea dictumst. Quisque blandit arcu nulla, quis pharetra nisl rhoncus luctus. In hac habitasse platea dictumst. Proin ac urna sed ex malesuada pretium. Cras at faucibus tellus. Nunc porttitor, tortor vel imperdiet mollis, est neque lobortis tellus, in imperdiet erat metus non nisl. Suspendisse nec suscipit metus. Aenean vel pulvinar justo. Aliquam erat volutpat. Phasellus sit amet felis nec nisi interdum viverra et sit amet ligula. Vivamus fringilla auctor velit nec interdum.
...
3Drender=ShadedIllustration,
% defult view end
]{\includegraphics{figures/2_spim/DualMouse/DualMirror.png}}{figures/2_spim/DualMouse/DualMirror.prc}
...
\chapter{Real-time image processing}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{figures/3_compression/intro/huffman}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{figures/3_compression/intro/arithmetic}
...
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{figures/3_compression/intro/DCT_bases}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{figures/3_compression/intro/wavelet}
