...
\begin{figure}[tpb]
 \centering
 \includegraphics[page=1,width=0.4\textwidth]{figures/2_spim/efficiency/sphere}
 \caption{\textbf{Light collection efficiency of an objective.} Light collection efficiency is the ratio of photons collected by the objective and all emitted photons. If the fluorophores are emitted randomly in all directions, it will be the ratio of the surf}
...
\subsection{Image registration techniques}
\subsection{Image fusion techniques}
	\subsubsection{Average}
	\subsubsection{Weighted average (image blending)}
	\subsubsection{Fourier mixing?}
